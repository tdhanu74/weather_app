  ...
  return (
    <div className="flex flex-col gap-12 pt-8">
      <div className="flex flex-row gap-4 h-full">
        <div className="grid grid-rows-2 h-full w-2/5 gap-4">
          {
            loading ?
              <div className="flex grow rounded-lg shadow w-full h-32 bg-white-glass-2 backdrop-blur-md animate-pulse" />
              : <div className="flex flex-row justify-between h-full w-full overflow-hidden rounded-xl bg-white-glass-2 shadow backdrop-blur-md p-4">
        ...
        {
          loading ?
            <div className="flex grow rounded-lg shadow w-1/5 h-[17rem] bg-white-glass-2 backdrop-blur-md animate-pulse" />
            : <div className="flex flex-col h-full w-1/5 overflow-hidden rounded-xl bg-white-glass-2 shadow backdrop-blur-md p-4">
      ...
      <div className="grid grid-cols-6 gap-4 h-full">
        {
          loading ?
            Array.from([1, 2, 3, 4, 5, 6]).map(temp => <div key={temp} className="h-[14.5rem] w-full rounded-xl bg-white-glass-2 shadow backdrop-blur-sm animate-pulse" />)
